          ...
          <div style={{ maxWidth: 920, margin: "0 auto" }}>
            {[
              ...
              { time: "18h00", fr: "Cocktail / Vin d'honneur", en: "Cocktail hour",
                fr_d: "Le vin d'honneur, c'est le monde qui se retrouve. Les familles se découvrent, les vieux amis se reconnaissent d'un sourire. Les enfants courent entre les adultes, les verres s'entrechoquent. Pendant que le couple était avec nous, la fête s'est organisée sans eux. Quand ils réapparaissent, il y a une façon d'applaudir qui dit tout.",
              ...
              { time: "20h00", fr: "Dîner", en: "Dinner",
                fr_d: "Une salle décorée, des tables soignées. Le plan de table est une surprise — les invités découvrent, s'amusent, s'émerveillent. Puis la musique, les mariés entrent sous les acclamations. La soirée peut commencer. On se défoule puis on s'assoit pour le dîner — un tour des tables pour les photos de groupe. Puis viennent les discours, les interventions, les jeux — certains préparés depuis des semaines, d'autres improvisés au micro. Les larmes ne préviennent pas, les rires non plus.",

          ...
          <div style={{ maxWidth: 920, margin: "0 auto" }}>
            {[
              ...
              { time: "17h00", fr: "Séance photo", en: "Portrait session",
                fr_d: "Ils se sont dit oui. À la sortie, la joie explose — bulles et pétales brillent dans la lumière, tout le monde veut sa photo avec les mariés. Puis le couple s'éclipse. C'est notre moment : trente minutes, à l'écart, loin du bruit.",
